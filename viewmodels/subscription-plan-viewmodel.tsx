  ...
  const config = useMemo(
    () => ({
      ...
      createFields: [
        ...
        {
          name: "maxDevices",
          label: t("plan.devices.maxDevices"),
          type: "number" as const,
          placeholder: "0",
          min: 0,
          helperText: t("plan.devices.maxDevicesHelper"),
        },
        {
          name: "requireMachineBinding",
          label: t("plan.devices.requireMachineBinding"),
          type: "checkbox" as const,
          helperText: t("plan.devices.requireMachineBindingHelper"),
        },
        {
          name: "deviceReplacementPolicy",
          label: t("plan.devices.replacementPolicy"),
          type: "select" as const,
          options: [
            { value: "0", label: t("plan.devices.policies.autoReplaceOldest") },
            { value: "1", label: t("plan.devices.policies.autoReplaceLeastActive") },
            { value: "2", label: t("plan.devices.policies.adminApproval") },
          ],
          helperText: t("plan.devices.replacementPolicyHelper"),
          isVisible: (formData: any) => formData.requireMachineBinding === true,
        },
        {
          name: "hardwareChangeTolerance",
          label: t("plan.devices.hardwareChangeTolerance"),
          type: "number" as const,
          placeholder: "2",
          min: 0,
          max: 10,
          helperText: t("plan.devices.hardwareChangeToleranceHelper"),
          isVisible: (formData: any) => formData.requireMachineBinding === true,
        },
        {
          name: "allowConcurrentUsage",
          label: t("plan.devices.allowConcurrentUsage"),
          type: "checkbox" as const,
          helperText: t("plan.devices.allowConcurrentUsageHelper"),
          isVisible: (formData: any) => formData.requireMachineBinding === true,
        },
        {
          name: "concurrentUsageTimeoutMinutes",
          label: t("plan.devices.concurrentUsageTimeout"),
          type: "number" as const,
          placeholder: "30",
          min: 5,
          max: 1440,
          helperText: t("plan.devices.concurrentUsageTimeoutHelper"),
          isVisible: (formData: any) => formData.requireMachineBinding === true && formData.allowConcurrentUsage === true,
        },
      ],
      editFields: [
        {
