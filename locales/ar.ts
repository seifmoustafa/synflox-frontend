export const ar = {
  ...
  company: {
    ...
    detail: {
      ...
      trial: {
        title: "فترة التجربة",
        status: "حالة التجربة",
        description: "معلومات وإدارة فترة التجربة",
        active: "تجربة نشطة",
        endDate: "تاريخ الانتهاء",
        daysRemaining: "{{days}} أيام متبقية",
        start: "بدء التجربة",
        startDescription: "بدء فترة تجربة لهذه الشركة",
        convert: "التحويل إلى مدفوع",
        convertDescription: "تحويل اشتراك التجربة إلى اشتراك مدفوع",
        days: "مدة التجربة (بالأيام)",
      },
      subscriptionPlan: {
        title: "خطة الاشتراك",
        description: "خطة الاشتراك المعينة لهذه الشركة",
        change: "تغيير الخطة",
        changeDescription: "تغيير خطة الاشتراك لهذه الشركة",
        selectPlan: "اختر الخطة",
        noPlan: "لم يتم تعيين خطة اشتراك",
        assign: "تعيين خطة",
      },
      licenseKey: {
        title: "إدارة مفتاح الترخيص",
        description: "إنشاء وإدارة مفاتيح الترخيص لهذه الشركة",
        generate: "إنشاء مفتاح الترخيص",
        regenerate: "إعادة إنشاء مفتاح الترخيص",
      },
      analytics: {
        description: "عرض تحليلات وإحصائيات الاستخدام لهذه الشركة",
        viewFull: "عرض التحليلات الكاملة",
      },
      history: {
        title: "سجل الاشتراك",
        description: "عرض سجل الاشتراك وسجلات التدقيق",
        viewHistory: "عرض السجل الكامل",
        embedded: "سيتم عرض الجدول الزمني للسجل هنا",
        embeddedDescription: "انقر على 'عرض السجل الكامل' لرؤية سجل الاشتراك الكامل",
        noHistory: "لا يوجد سجل اشتراك متاح",
        showMore: "عرض {{count}} المزيد",
        showLess: "عرض أقل",
      },
      customFields: {
        title: "الحقول المخصصة",
        description: "إدارة الحقول المخصصة لهذه الشركة",
        addField: "إضافة حقل",
        editField: "تعديل حقل",
        addFieldDescription: "إضافة حقل مخصص جديد لهذه الشركة",
        editFieldDescription: "تعديل الحقل المخصص",
        fieldName: "اسم الحقل",
        fieldNamePlaceholder: "أدخل اسم الحقل",
        fieldType: "نوع الحقل",
        fieldValue: "قيمة الحقل",
        fieldValuePlaceholder: "أدخل قيمة الحقل",
        jsonPlaceholder: "أدخل JSON صالح",
        noFields: "لم يتم تعريف حقول مخصصة",
        field: "حقل",
        types: {
          string: "نص",
          number: "رقم",
  ...
  licensing: {
    ...
    bulkSuspend: "تعليق مجمع",
    bulkResume: "استئناف مجمع",
    bulkExtend: "تمديد مجمع",
    confirmBulkActivate: "هل أنت متأكد من تفعيل {count} شركة؟",
    confirmBulkSuspend: "هل أنت متأكد من تعليق {count} شركة؟",
    confirmBulkResume: "هل أنت متأكد من استئناف {count} شركة؟",
    confirmBulkExtend: "هل أنت متأكد من تمديد {count} شركة؟",
    startTrial: "بدء التجربة",
    convertTrial: "تحويل التجربة",
    trial: "تجربة",
  ...
  dashboard: {
    ...
    expiryTimeline: {
      ...
      daysUntilExpiry: "الأيام حتى الانتهاء",
      critical: "حرج",
      warning: "تحذير",
      days: "أيام",
      day: "يوم",
  ...
  subscriptionPlan: {
    ...
    items: "خطط الاشتراك",
    name: "الاسم",
    namePlaceholder: "أدخل اسم الخطة",
    descriptionLabel: "الوصف",
    descriptionPlaceholder: "أدخل وصف الخطة",
    price: "السعر",
    pricePlaceholder: "أدخل السعر",
    currency: "العملة",
    currencyPlaceholder: "أدخل رمز العملة (مثل: USD)",
    ...
    detail: {
      ...
      description: "عرض وإدارة تفاصيل خطة الاشتراك",
      tabs: {
        overview: "نظرة عامة",
        modules: "الوحدات",
        companies: "الشركات",
      ...
      basicInfo: "المعلومات الأساسية",
      basicInfoDescription: "اسم الخطة والوصف ومعلومات الأسعار",
      features: "الميزات",
      featuresDescription: "ميزات وقدرات الخطة",
      noFeatures: "لم يتم تعريف ميزات",
      modulesDescription: "وحدات المشروع المعينة لهذه الخطة ({count} مفعل)",
      companiesDescription: "الشركات التي تستخدم هذه الخطة ({count} إجمالي)",
      statisticsDescription: "إحصائيات ومقاييس استخدام الخطة",
      noModules: "لم يتم تعيين وحدات لهذه الخطة",
      noCompanies: "لا توجد شركات تستخدم هذه الخطة",
      noModulesAvailable: "لا توجد وحدات متاحة للتعيين",
      addedAt: "تمت الإضافة في",
      metadata: "البيانات الوصفية",
      metadataDescription: "معلومات إنشاء وتحديث الخطة",
    ...
    error: {
      title: "خطأ في تحميل خطة الاشتراك",
      loadFailed: "فشل تحميل تفاصيل خطة الاشتراك",
      notFound: "خطة الاشتراك غير موجودة",
    },
  },
  ...
  project: {
    ...
    status: "الحالة",
    detail: {
      description: "عرض وإدارة تفاصيل المشروع",
      overview: "نظرة عامة",
      overviewDescription: "معلومات وتفاصيل المشروع",
      metadata: "البيانات الوصفية",
      metadataDescription: "معلومات إنشاء وتحديث المشروع",
      createdAt: "تم الإنشاء في",
      updatedAt: "تم التحديث في",
      ...
      modulesDescription: "الوحدات في هذا المشروع",
      addModule: "إضافة وحدة",
      addModuleDescription: "إضافة وحدات إلى {{projectName}}",
      addSelected: "إضافة المحدد",
      removeModule: "إزالة وحدة",
      noModules: "لا توجد وحدات في هذا المشروع",
      noModulesAvailable: "لا توجد وحدات متاحة للإضافة",
      addedAt: "تمت الإضافة في",
      unknown: "غير معروف",
    },
    error: {
      title: "خطأ في تحميل المشروع",
      loadFailed: "فشل تحميل تفاصيل المشروع",
  ...
  companyGroup: {
    ...
    description: "إدارة مجموعات وفئات الشركات",
    item: "مجموعة شركات",
    items: "مجموعات الشركات",
    name: "الاسم",
    ...
    isActive: "نشط",
    status: "الحالة",
    companyCount: "الشركات",
    manageCompanies: "إدارة الشركات",
    manageCompaniesDescription: "إضافة أو إزالة الشركات من {{groupName}}",
    detail: {
      title: "تفاصيل مجموعة الشركات",
      description: "عرض وإدارة تفاصيل مجموعة الشركات",
      tabs: {
        overview: "نظرة عامة",
        companies: "الشركات",
        statistics: "الإحصائيات",
      ...
      basicInfo: "المعلومات الأساسية",
      basicInfoDescription: "اسم المجموعة والوصف والحالة",
      metadata: "البيانات الوصفية",
      metadataDescription: "معلومات إنشاء وتحديث المجموعة",
      createdAt: "تم الإنشاء في",
      updatedAt: "تم التحديث في",
      noDescription: "لا يوجد وصف",
      companiesDescription: "الشركات في هذه المجموعة ({{count}} إجمالي)",
      noCompanies: "لا توجد شركات في هذه المجموعة",
      addCompanies: "إضافة شركات",
      addCompaniesDescription: "إضافة شركات إلى {{groupName}}",
      addSelected: "إضافة المحدد",
      ...
      bulkResume: "استئناف مجمع",
      bulkExtend: "تمديد مجمع",
      confirmBulkActivateTitle: "تفعيل الشركات بشكل مجمع",
      confirmBulkActivateDescription: "هل أنت متأكد من تفعيل {{count}} شركة في هذه المجموعة؟ ستحتاج إلى تحديد تاريخ انتهاء.",
      confirmBulkSuspendTitle: "تعليق الشركات بشكل مجمع",
      confirmBulkSuspendDescription: "هل أنت متأكد من تعليق {{count}} شركة في هذه المجموعة؟ سيتم منعها من الوصول إلى النظام.",
      confirmBulkResumeTitle: "استئناف الشركات بشكل مجمع",
      confirmBulkResumeDescription: "هل أنت متأكد من استئناف {{count}} شركة في هذه المجموعة؟ سيتم استعادة وصولها إلى النظام.",
      confirmBulkExtendTitle: "تمديد الشركات بشكل مجمع",
      confirmBulkExtendDescription: "هل أنت متأكد من تمديد {{count}} شركة في هذه المجموعة؟ ستحتاج إلى تحديد تاريخ انتهاء جديد.",
      statistics: "الإحصائيات",
      totalCompanies: "إجمالي الشركات",
      activeCompanies: "الشركات النشطة",
      expiredCompanies: "الشركات المنتهية",
    ...
    error: {
      title: "خطأ في تحميل مجموعة الشركات",
      loadFailed: "فشل تحميل تفاصيل مجموعة الشركات",
      notFound: "مجموعة الشركات غير موجودة",
    },
  },
  ...
  module: {
    ...
    detail: {
      title: "تفاصيل الوحدة",
      description: "عرض وإدارة تفاصيل الوحدة",
      tabs: {
        overview: "نظرة عامة",
        projects: "المشاريع",
        plans: "الخطط",
      ...
      basicInfo: "المعلومات الأساسية",
      basicInfoDescription: "اسم الوحدة والوصف والحالة",
      metadata: "البيانات الوصفية",
      metadataDescription: "معلومات إنشاء وتحديث الوحدة",
      createdAt: "تم الإنشاء في",
      updatedAt: "تم التحديث في",
      noDescription: "لا يوجد وصف",
      projectsDescription: "المشاريع التي تتضمن هذه الوحدة ({count} إجمالي)",
      plansDescription: "خطط الاشتراك التي تتضمن هذه الوحدة ({count} إجمالي)",
      noProjects: "هذه الوحدة غير معينة لأي مشاريع",
      noPlans: "هذه الوحدة غير متضمنة في أي خطط اشتراك",
      statistics: "الإحصائيات",
    ...
    error: {
      title: "خطأ في تحميل الوحدة",
      loadFailed: "فشل تحميل تفاصيل الوحدة",
  ...
  apiKey: {
    title: "مفاتيح API",
    description: "إدارة مفاتيح API للمصادقة للشركات",
    item: "مفتاح API",
    items: "مفاتيح API",
    name: "الاسم",
    namePlaceholder: "أدخل اسم مفتاح API",
    descriptionLabel: "الوصف",
    descriptionPlaceholder: "أدخل وصف مفتاح API",
    key: "المفتاح",
    company: "الشركة",
    ...
    neverUsed: "لم يُستخدم أبداً",
    expiresAt: "ينتهي في",
    expiresAtPlaceholder: "اختر تاريخ الانتهاء (اختياري)",
    ...
    showKey: {
      ...
      description: "هذا هو مفتاح API الخاص بك. انسخه الآن - لن تتمكن من رؤيته مرة أخرى!",
      warning: "تأكد من نسخ مفتاح API الآن. لن تتمكن من رؤيته مرة أخرى بعد إغلاق هذه النافذة.",
    },
    detail: {
      title: "تفاصيل مفتاح API",
      description: "عرض وإدارة تفاصيل مفتاح API",
      tabs: {
        overview: "نظرة عامة",
        usage: "الاستخدام",
        settings: "الإعدادات",
      ...
      basicInfo: "المعلومات الأساسية",
      basicInfoDescription: "اسم مفتاح API والوصف والحالة",
      metadata: "البيانات الوصفية",
      metadataDescription: "معلومات إنشاء واستخدام مفتاح API",
      createdAt: "تم الإنشاء في",
      updatedAt: "تم التحديث في",
      noDescription: "لا يوجد وصف",
      regenerate: "إعادة توليد المفتاح",
      revoke: "إلغاء المفتاح",
      confirmDelete: "هل أنت متأكد من إلغاء مفتاح API هذا؟ لا يمكن التراجع عن هذا الإجراء.",
      usageDescription: "إحصائيات وتحليلات استخدام مفتاح API",
      usageStatsNote: "يتم تتبع إحصائيات الاستخدام تلقائياً. التحليلات التفصيلية قريباً.",
      settingsDescription: "إعدادات وتكوين مفتاح API",
      settingsNote: "يمكن تعديل الإعدادات باستخدام زر التعديل. ميزات القائمة البيضاء لـ IP وتحديد معدل الاستخدام قريباً.",
      neverUsed: "لم يُستخدم أبداً",
    },
    error: {
      title: "خطأ في تحميل مفتاح API",
      loadFailed: "فشل تحميل تفاصيل مفتاح API",
  ...
  webhook: {
    title: "Webhooks",
    description: "إدارة Webhooks لإشعارات الأحداث",
    item: "Webhook",
    items: "Webhooks",
    url: "الرابط",
    ...
    companyPlaceholder: "اختر الشركة",
    secret: "السر",
    secretPlaceholder: "سر اختياري للتوقيع",
    eventTypesLabel: "أنواع الأحداث",
    eventTypesPlaceholder: "اختر أنواع الأحداث",
    status: "الحالة",
    isActive: "نشط",
    retryCount: "عدد المحاولات",
    retryCountPlaceholder: "عدد محاولات إعادة المحاولة",
    timeoutSeconds: "الوقت المتاح (بالثواني)",
    timeoutSecondsPlaceholder: "وقت انتهاء الطلب بالثواني",
    lastDeliveryAt: "آخر تسليم",
    neverDelivered: "لم يتم التسليم أبداً",
    viewDeliveries: "عرض التسليمات",
    retryFailed: "إعادة محاولة التسليمات الفاشلة",
    deliveries: {
      title: "سجل التسليم",
      description: "عرض سجل التسليم لـ {{url}}",
      noDeliveries: "لا توجد تسليمات بعد",
    ...
    eventTypes: {
      ...
      companySuspended: "تم تعليق الشركة",
      companyResumed: "تم استئناف الشركة",
      companyExpired: "انتهت صلاحية الشركة",
      companyExtended: "تم تمديد الشركة",
      companyDeleted: "تم حذف الشركة",
      licenseKeyGenerated: "تم إنشاء مفتاح الترخيص",
      trialStarted: "بدأت التجربة",
      trialConverted: "تم تحويل التجربة",
    },
    error: {
      eventTypesRequired: "يجب اختيار نوع حدث واحد على الأقل",
      invalidRequest: "طلب webhook غير صالح. يرجى التحقق من جميع الحقول المطلوبة.",
      loadFailed: "فشل تحميل webhook",
      notFound: "webhook غير موجود",
    },
    detail: {
      title: "تفاصيل Webhook",
      description: "عرض وإدارة تفاصيل Webhook",
      tabs: {
        overview: "نظرة عامة",
      ...
      basicInfo: "المعلومات الأساسية",
      basicInfoDescription: "رابط Webhook والسر وأنواع الأحداث",
      metadata: "البيانات الوصفية",
      metadataDescription: "معلومات إنشاء وتسليم Webhook",
      createdAt: "تم الإنشاء في",
      noSecret: "لم يتم تكوين سر",
      deliveryHistory: "سجل التسليم لهذا Webhook",
      noDeliveries: "لم يتم تسجيل أي تسليمات بعد",
      retryFailed: "إعادة محاولة التسليمات الفاشلة",
      confirmDelete: "هل أنت متأكد من حذف هذا Webhook؟ لا يمكن التراجع عن هذا الإجراء.",
      settingsDescription: "إعدادات وتكوين Webhook",
      settingsNote: "يمكن تعديل الإعدادات باستخدام زر التعديل.",
      editNote: "استخدم زر التعديل في الرأس لتعديل إعدادات Webhook.",
      statistics: "الإحصائيات",
      totalDeliveries: "إجمالي التسليمات",
      successfulDeliveries: "التسليمات الناجحة",
      failedDeliveries: "التسليمات الفاشلة",
  ...
  analytics: {
    title: "التحليلات",
    description: "عرض تحليلات وإحصائيات الاستخدام",
    filters: "الفلاتر",
    filtersDescription: "تصفية التحليلات حسب النطاق الزمني",
    fromDate: "من تاريخ",
    toDate: "إلى تاريخ",
    apply: "تطبيق",
    totalRequests: "إجمالي الطلبات",
    ...
    failed: "فشلت",
    requests: "الطلبات",
    requestsByDay: "الطلبات حسب اليوم",
    requestsByDayDescription: "اتجاهات الطلبات اليومية مع مرور الوقت",
    requestsByEndpoint: "الطلبات حسب نقطة النهاية",
    requestsByEndpointDescription: "أفضل نقاط النهاية حسب عدد الطلبات",
    requestsByCompany: "الطلبات حسب الشركة",
    requestsByCompanyDescription: "أفضل الشركات حسب عدد الطلبات",
  ...
  common: {
    ...
    exportFormatCsv: "CSV",
    exportFormatPlaceholder: "اختر تنسيق التصدير",
    exportCreating: "جاري إنشاء ملف التصدير...",
    exportSuccess: "تم إنشاء ملف التصدير بنجاح! جاري بدء التحميل...",
    exportCompleted: "اكتمل التحميل",
    import: "استيراد",
    save: "حفظ",
    cancel: "إلغاء",
    delete: "حذف",
  ...
  datePickerModal: {
    ...
    dateMustBeFuture: "يجب أن يكون التاريخ في المستقبل",
