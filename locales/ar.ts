export const ar = {
  ...
  auth: {
    ...
    secureLogin: "تسجيل دخول آمن للمسؤولين",
    // Branding
    tagline: "نظام إدارة التراخيص المركزي",
    subtitle: "منصة إدارة تراخيص البرامج المؤسسية",
    mission: "توقف عن بناء أنظمة الترخيص. ابدأ ببناء المنتجات.",
    trusted: "موثوق به من قبل أكثر من {count} مؤسسة عالمياً",
    // Features
    featureEnterpriseSecurity: "أمان مؤسسي",
    featureEnterpriseSecurityDesc: "تشفير AES-256 مع حماية من التلاعب",
    featureMultiProduct: "منتجات متعددة",
    featureMultiProductDesc: "نظام موحد لجميع منتجاتك",
    featureFlexibleBilling: "فوترة مرنة",
    featureFlexibleBillingDesc: "خطط اشتراك من أسبوعية إلى مدى الحياة",
    featureRealtimeValidation: "التحقق الفوري",
    featureRealtimeValidationDesc: "التحقق والتحكم الفوري في التراخيص",
    // Stats
  ...
  security: {
    // General
    title: "الأمان",
    subtitle: "إدارة إعدادات أمان حسابك وطرق المصادقة",
    overview: "نظرة عامة",
    overviewDesc: "لوحة معلومات الأمان والتوصيات",
    password: "كلمة المرور",
    passwordDesc: "تغيير كلمة مرور حسابك",
    twoFactor: "المصادقة الثنائية",
    twoFactorDesc: "إدارة إعدادات المصادقة الثنائية",
    backupCodes: "رموز النسخ الاحتياطي",
    backupCodesDesc: "رموز الاسترداد للمصادقة الثنائية",
    
    // Security Overview
    securityScore: "نقاط الأمان",
    securityScoreDesc: "تقييم أمان الحساب الشامل",
    enabled: "مفعل",
    disabled: "معطل",
    ...
    changePasswordWith2FADesc: "تغيير كلمة المرور يتطلب التحقق بالمصادقة الثنائية",
    ...
    resetPasswordInfo: "ستتلقى بريدًا إلكترونيًا يحتوي على تعليمات لإعادة تعيين كلمة المرور. سيتم تسجيل خروجك من جميع الجلسات.",
    sendResetLink: "إرسال رابط إعادة التعيين",
    resetEmailSent: "تم إرسال بريد إعادة التعيين!",
    resetEmailSentDesc: "تحقق من بريدك الإلكتروني للحصول على تعليمات إعادة تعيين كلمة المرور. سينتهي صلاحية الرابط خلال 15 دقيقة.",
    ...
    magicLinkSentDesc: "تحقق من بريدك الإلكتروني وانقر على الرابط لإعادة تعيين كلمة المرور. سينتهي صلاحية الرابط خلال 15 دقيقة.",
    newPassword: "كلمة المرور الجديدة",
    enterNewPassword: "أدخل كلمة المرور الجديدة",
    confirmPassword: "تأكيد كلمة المرور",
    confirmNewPassword: "أكد كلمة المرور الجديدة",
    enterPassword: "أدخل كلمة المرور",
    passwordRequirements: "8 أحرف على الأقل، حروف كبيرة وصغيرة، رقم، رمز خاص",
    ...
    twoFactorRequired: "مطلوب التحقق بالمصادقة الثنائية",
    enter2FACode: "أدخل رمز المصادقة الثنائية من تطبيق المصادقة",
    setupAuthenticator: "إعداد المصادق",
    scanQRCode: "امسح رمز QR باستخدام تطبيق المصادقة",
    manualEntry: "أو أدخل هذا المفتاح يدويًا",
    enter6DigitCode: "أدخل الرمز المكون من 6 أرقام من تطبيقك",
    verifyAndEnable: "التحقق والتفعيل",
    disable2FATitle: "تعطيل المصادقة الثنائية؟",
    disable2FAWarning: "سيؤدي هذا إلى جعل حسابك أقل أمانًا. أدخل كلمة المرور للتأكيد.",
    reset2FATitle: "إعادة تعيين المصادقة الثنائية",
    reset2FADesc: "توليد سر ورمز QR جديد. أدخل كلمة المرور للتأكيد.",
    recommendedApps: "تطبيقات المصادقة الموصى بها",
    "2FAEnabledDesc": "حسابك محمي بالمصادقة الثنائية",
    "2FADisabledDesc": "أضف طبقة إضافية من الأمان لحسابك",
    enable2FAError: "فشل تفعيل المصادقة الثنائية",
    verify2FAError: "فشل التحقق من رمز المصادقة الثنائية",
    disable2FAError: "فشل تعطيل المصادقة الثنائية",
    reset2FAError: "فشل إعادة تعيين المصادقة الثنائية",
    invalid2FACode: "رمز المصادقة الثنائية غير صحيح",
    use2FACode: "استخدم رمز المصادقة الثنائية بدلاً من ذلك",
    
    // Backup Codes
    generateNewCodes: "توليد رموز جديدة",
    generateBackupCodes: "توليد رموز النسخ الاحتياطي",
    generateCodesDesc: "سيؤدي هذا إلى إبطال جميع رموز النسخ الاحتياطي السابقة. أدخل كلمة المرور للتأكيد.",
    yourBackupCodes: "رموز النسخ الاحتياطي الخاصة بك",
    saveCodesWarning: "احفظ هذه الرموز الآن! سيتم عرضها مرة واحدة فقط.",
    exportCodes: "تصدير الرموز",
    exportText: "ملف نصي",
    exportJSON: "JSON",
    exportPDF: "PDF",
    copyAllCodes: "نسخ جميع الرموز",
    closeAndFinish: "إغلاق وإنهاء",
    deleteAllCodes: "حذف جميع رموز النسخ الاحتياطي؟",
    deleteCodesWarning: "لا يمكن التراجع عن هذا الإجراء. ستحتاج إلى توليد رموز جديدة لاستخدام استرداد رمز النسخ الاحتياطي.",
    deleteAll: "حذف الكل",
    noCodesRemaining: "تم استخدام جميع رموز النسخ الاحتياطي! قم بتوليد رموز جديدة فورًا.",
    lowCodesWarning: "نفاد رموز النسخ الاحتياطي. فكر في توليد رموز جديدة.",
    aboutBackupCodes: "حول رموز النسخ الاحتياطي",
    backupCodesInfo1: "كل رمز يمكن استخدامه مرة واحدة فقط",
    backupCodesInfo2: "احفظها في مكان آمن",
    backupCodesInfo3: "استخدمها إذا فقدت الوصول إلى تطبيق المصادقة",
    backupCodesInfo4: "قم بتوليد رموز جديدة عندما تنخفض",
    useBackupCode: "استخدم رمز النسخ الاحتياطي بدلاً من ذلك",
    loadStatusError: "فشل تحميل حالة رموز النسخ الاحتياطي",
    generateCodesError: "فشل توليد رموز النسخ الاحتياطي",
    exportCodesError: "فشل تصدير رموز النسخ الاحتياطي",
    deleteCodesError: "فشل حذف رموز النسخ الاحتياطي",
    codeCopied: "تم نسخ الرمز إلى الحافظة",
    allCodesCopied: "تم نسخ جميع الرموز إلى الحافظة",
    copyError: "فشل نسخ الرمز",
    codesExported: "تم تصدير رموز النسخ الاحتياطي بنجاح",
    invalidExportFormat: "تنسيق التصدير غير صحيح",
    
    // Status Messages
    passwordStatus: "آخر تغيير منذ 90 يومًا",
    twoFactorStatus: "غير مفعلة",
    backupCodesStatus: "8 من 10 رموز متبقية",
    overviewStatus: "آخر تسجيل دخول: اليوم",
    recommended: "موصى به",
    recommendedTitle: "إجراء مطلوب",
    recommendedDesc: "نوصي بتأمين حسابك باستخدام المصادقة الثنائية وتحديث كلمة المرور بانتظام.",
    
    // Delete Account
    deleteAccount: "حذف الحساب",
    deleteAccountWarning: "هذا الإجراء دائم ولا يمكن التراجع عنه",
    beforeDelete: "قبل حذف حسابك",
    beforeDeleteDesc: "يرجى قراءة وفهم ما يلي:",
    deletePolicy1: "سيتم حذف جميع بياناتك الشخصية بشكل دائم",
    deletePolicy2: "ستفقد الوصول إلى جميع شركاتك وتراخيصك",
    deletePolicy3: "سيتم إلغاء الاشتراكات النشطة على الفور",
    deletePolicy4: "لا يمكن عكس هذا الإجراء أو التراجع عنه",
    deletePolicy5: "ستحتاج إلى إنشاء حساب جديد لاستخدام خدماتنا مرة أخرى",
    confirmation: "التأكيد مطلوب",
    agreeDelete: "أفهم أن حذف حسابي دائم ولا يمكن التراجع عنه. أريد المتابعة في حذف حسابي وجميع البيانات المرتبطة.",
    deleteAccountPermanently: "حذف الحساب نهائيًا",
    noUndo: "لا يمكن التراجع عن هذا",
    finalWarning: "تحذير نهائي",
    finalWarningDesc: "هل أنت متأكد تمامًا من رغبتك في حذف حسابك؟",
    yesDelete: "نعم، احذف",
    ...
    generate: "توليد",
    delete: "حذف",
    loadDashboardError: "فشل تحميل لوحة معلومات الأمان",
  },
  ...
  dashboard: {
    ...
    // Alerts
    criticalAlert: "التنبيهات الحرجة تتطلب اهتماماً فورياً!",
    systemAlerts: "تنبيهات النظام",
    noAlerts: "لا توجد تنبيهات - جميع الأنظمة تعمل بشكل طبيعي",
    critical: "حرجة",
    warnings: "تحذيرات",
    expiringToday: "تنتهي اليوم",
    expiringThisWeek: "تنتهي هذا الأسبوع",
    companiesSuspended: "شركات معلقة",
    ...
    planDistribution: "توزيع الخطط حسب الشركات",
    statusBreakdown: "تقسيم الحالات",
    activeSubscriptions: "نشطة",
    trialSubscriptions: "تجريبية",
    expiredSubscriptions: "منتهية الصلاحية",
    topPlan: "أفضل خطة اشتراك",
    expirations: "انتهاءات الصلاحية",
    expiring7Days: "تنتهي خلال 7 أيام",
    expiring30Days: "تنتهي خلال 30 يوم",
    adminStats: "إحصائيات المسؤولين",
    adminTypes: "أنواع المسؤولين",
    adminActivity: "نشاط المسؤولين",
    adminGrowth: "المسؤولون الجدد المُنشأون عبر الوقت",
    adminStatus: "حالة المسؤولين",
    activeVsInactive: "المسؤولون النشطون مقابل غير النشطين",
    ...
    // System Health
    systemHealth: "صحة النظام",
    overallActivity: "معدل النشاط الإجمالي",
    lastUpdated: "آخر تحديث",
    
    // Analytics Tab
    analytics: {
      companyHealth: "صحة الشركات",
      subscriptionHealth: "صحة الاشتراكات",
      adminHealth: "صحة المسؤولين",
      activeRate: "معدل النشاط",
      performanceRadar: "رادار أداء النظام",
      performanceRadarDesc: "تحليل أداء النظام متعدد الأبعاد",
      ...
      comparativeGrowth: "تحليل النمو المقارن",
      comparativeGrowthDesc: "مقارنة النمو عبر جميع الكيانات",
      activityFunnel: "مسار النشاط",
      activityFunnelDesc: "تقدم النشاط على مستوى النظام",
      totalEntities: "إجمالي الكيانات",
      activeEntities: "الكيانات النشطة",
      recent24h: "النشطة خلال 24 ساعة",
      entities: "الكيانات",
      statusDistribution: "توزيع الحالات",
      statusDistributionDesc: "تفصيل شامل للحالات",
      issues: "مشاكل",
      trial: "تجريبي",
      companiesLast24h: "الشركات (24س)",
      subscriptionsLast24h: "الاشتراكات (24س)",
      adminsLast24h: "المسؤولون (24س)",
      newAdditions: "إضافات جديدة",
      newActivations: "تفعيلات جديدة",
      newTeamMembers: "أعضاء جدد",
      systemScore: "نقاط النظام",
      overallHealth: "الصحة العامة",
      criticalMetrics: "المقاييس الحرجة",
      expiringToday: "تنتهي اليوم",
      expiredCompanies: "شركات منتهية",
      suspendedCompanies: "شركات معلقة",
      inactiveAdmins: "مسؤولون غير نشطين",
    ...
    revenue: {
      ...
      totalRevenue: "إجمالي الإيرادات",
      totalSubscriptionValue: "إجمالي قيمة الاشتراكات",
    ...
    lifecycle: {
      new: "جديد",
      newDesc: "الشركات المُنشأة حديثاً",
      active: "نشط",
      activeDesc: "الشركات النشطة الصحية",
      atRisk: "معرض للخطر",
      atRiskDesc: "شركات تحتاج اهتمام",
      churned: "متوقف",
      churnedDesc: "الشركات غير النشطة",
      returning: "عائد",
      returningDesc: "الشركات المُعاد تفعيلها",
      stagesChart: "مراحل دورة الحياة",
      stagesChartDesc: "توزيع دورة حياة العملاء",
      healthChart: "توزيع الصحة",
      healthChartDesc: "درجات صحة الشركات",
      healthMetrics: "مقاييس الصحة",
      healthyCompanies: "الشركات الصحية",
      unhealthyCompanies: "الشركات غير الصحية",
      healthRate: "معدل الصحة",
      totalCompanies: "إجمالي الشركات",
      companies: "الشركات",
      excellent: "ممتاز",
      good: "جيد",
    ...
    churn: {
      ...
      churnRateDesc: "نسبة فقد العملاء",
      retentionRate: "معدل الاحتفاظ",
      retentionRateDesc: "نسبة الاحتفاظ بالعملاء",
      avgLifetime: "متوسط العمر",
      avgLifetimeDesc: "بالأشهر",
      highRisk: "عالي الخطورة",
      highRiskDesc: "شركات معرضة لخطر الفقد",
      riskChart: "توزيع المخاطر",
      riskChartDesc: "مستويات خطر الفقد",
      lowRisk: "خطر منخفض",
      mediumRisk: "خطر متوسط",
      status: "حالة الفقد",
      statusHealthy: "فقد منخفض - احتفاظ ممتاز",
      statusWarning: "فقد متوسط - مراقبة دقيقة",
      statusCritical: "فقد مرتفع - تدخل فوري مطلوب",
      retentionStatus: "حالة الاحتفاظ",
      retentionExcellent: "معدل احتفاظ ممتاز",
      retentionGood: "معدل احتفاظ جيد",
      retentionPoor: "معدل احتفاظ ضعيف - يحتاج تحسين",
  ...
  company: {
    ...
    phone: "الهاتف",
    notFound: "الشركة غير موجودة",
    quickActionsDescription: "إجراء العمليات الشائعة لهذه الشركة",
  ...
  plan: {
    ...
    duration: {
      ...
      biweekly: "نصف شهري (14 يوم)",
      monthly: "شهري (شهر واحد)",
      quarterly: "ربع سنوي (3 أشهر)",
      semiannually: "نصف سنوي (6 أشهر)",
      yearly: "سنوي (12 شهر)",
      biennial: "سنتان",
      triennial: "3 سنوات",
      lifetime: "مدى الحياة (لا تنتهي أبداً)",
    },
    price: "السعر",
    noPrice: "لم يتم تحديد السعر",
    currency: "العملة",
    amount: "المبلغ",
    priceAmount: "قيمة السعر",
    ...
    customFeaturesPlaceholder: "أضف ميزة (اضغط Enter)",
    customFeaturesHelper: "قائمة الميزات المضمنة في هذه الخطة",
    projects: "المشاريع",
    selectProjects: "اختر المشاريع",
    projectsHelper: "اختر المشاريع المضمنة في هذه الخطة",
    modules: "الوحدات",
    selectModules: "اختر الوحدات",
    modulesHelper: "اختر الوحدات المضمنة في هذه الخطة",
    allowTrial: "السماح بفترة تجريبية",
    trialDuration: "مدة التجربة (بالأيام)",
    trialHelper: "عدد الأيام للفترة التجريبية (1-60)",
    autoRenew: "تفعيل التجديد التلقائي",
    autoRenewHelper: "تجديد الاشتراكات تلقائياً",
    upgradePolicy: "سياسة الترقية",
    upgradePolicyHelper: "كيفية التعامل مع ترقيات الاشتراك",
    upgradePolicies: {
      fullReplace: "استبدال كامل - تبديل فوري",
      prorated: "تناسبي - احتساب الوقت المتبقي",
      deferred: "مؤجل - التبديل عند التجديد",
    },
  ...
  subscription: {
    ...
    noSubscriptionsDescription: "هذه الشركة ليس لديها أي اشتراكات حتى الآن",
    currentPlanDescription: "تفاصيل الاشتراك النشط الحالي",
    ...
    duplicatePlanNotAllowed: "الشركة لديها بالفعل اشتراك نشط بهذه الخطة",
    expiringWarning: "الاشتراك على وشك الانتهاء!",
    expiringWarningDesc: "سينتهي اشتراك {plan} خلال {days} أيام. جدد الآن لتجنب انقطاع الخدمة.",
    renewNow: "جدد الآن",
    timeline: "الخط الزمني للاشتراك",
    timelineDescription: "التاريخ الكامل لأحداث الاشتراك",
    viewHistory: "عرض التاريخ",
    exportSuccess: "تم تصدير تاريخ الاشتراك بنجاح",
    exportError: "فشل تصدير تاريخ الاشتراك",
    noFeatureData: "لا تتوفر بيانات استخدام الميزات",
    noUsageData: "لا تتوفر بيانات الاستخدام لهذه الفترة",
  ...
  // Company Admin (Client Admin Accounts)
  companyAdmin: {
    title: "مسؤول الشركة",
    description: "إدارة حساب مسؤول العميل",
    item: "مسؤول الشركة",
    items: "مسؤولو الشركات",
    company: "الشركة",
    username: "اسم المستخدم",
    usernamePlaceholder: "أدخل اسم المستخدم",
    password: "كلمة المرور",
    ...
    autoLogout: "تسجيل الخروج التلقائي عند عدم النشاط",
    inactivityTimeout: "مهلة عدم النشاط (دقائق)",
    newPassword: "كلمة المرور الجديدة",
    newPasswordPlaceholder: "أدخل كلمة المرور الجديدة (8 أحرف على الأقل)",
    mustChangeOnFirstLogin: "يجب تغيير كلمة المرور عند أول تسجيل دخول",
    resetPassword: "إعادة تعيين كلمة المرور",
    unlockAccount: "فتح الحساب",
    terminateSessions: "إنهاء الجلسات",
    viewSessions: "عرض الجلسات",
    sessionHistory: "سجل الجلسات",
    activeSessions: "الجلسات النشطة",
    noSessions: "لا توجد جلسات",
    maxFailedAttempts: "الحد الأقصى للمحاولات الفاشلة",
    // No admin state
    noAdmin: "لا يوجد حساب مسؤول",
    noAdminDescription: "أنشئ حساب مسؤول لـ {companyName} لإدارة التراخيص والأجهزة.",
    // Dialog titles
    createAdmin: "إنشاء حساب مسؤول",
    createAdminDescription: "إنشاء حساب مسؤول لـ {companyName}",
    editAdmin: "تعديل حساب المسؤول",
    editAdminDescription: "تحديث حساب المسؤول لـ {companyName}",
    deleteAdmin: "حذف حساب المسؤول",
    deleteAdminConfirmation: "هل أنت متأكد من حذف حساب المسؤول لـ {adminName}؟ لا يمكن التراجع عن هذا الإجراء.",
    resetPasswordDescription: "تعيين كلمة مرور جديدة لـ {adminName}",
    sessionHistoryDescription: "عرض سجل الجلسات لـ {adminName}",
    permissions: {
      title: "الصلاحيات",
      manageDevices: "إدارة الأجهزة",
      viewSubscriptions: "عرض الاشتراكات",
      approveReplacements: "الموافقة على الاستبدالات",
      generateLicenses: "إنشاء التراخيص",
      viewReports: "عرض التقارير",
      modifySessionSettings: "تعديل إعدادات الجلسة",
    },
    status: {
      active: "نشط",
      inactive: "غير نشط",
  ...
  account: {
    ...
    // Profile Edit Page
    editProfileDescription: "قم بتحديث معلوماتك الشخصية وإعداداتك",
    profilePicture: "صورة الملف الشخصي",
    profilePictureDescription: "قم بتحميل صورة الملف الشخصي لتخصيص حسابك",
    photoRequirements: "JPG أو PNG أو WEBP. الحد الأقصى للحجم 5 ميجابايت. سيتم تغيير حجم الصورة إلى 300×300.",
    uploadPhoto: "تحميل صورة",
    personalInformation: "المعلومات الشخصية",
    personalInformationDescription: "معلومات أساسية عنك",
    firstName: "الاسم الأول",
    ...
    professionalInformationDescription: "تفاصيل عملك ودورك",
    jobTitle: "المسمى الوظيفي",
    jobTitlePlaceholder: "مثال: مهندس برمجيات",
    department: "القسم",
    departmentPlaceholder: "مثال: الهندسة",
    workLocation: "الموقع",
    workLocationPlaceholder: "مثال: سان فرانسيسكو، كاليفورنيا",
    socialAndContact: "التواصل الاجتماعي والاتصال",
    socialAndContactDescription: "ملفاتك الشخصية الاجتماعية وجهة الاتصال الاحتياطية",
    linkedIn: "لينكد إن",
    ...
    errors: {
      ...
      uploadPhoto: "فشل تحميل صورة الملف الشخصي",
      removePhoto: "فشل إزالة صورة الملف الشخصي"
    }
  },
