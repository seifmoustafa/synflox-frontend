export const en = {
  ...
  company: {
    ...
    detail: {
      ...
      customFields: {
        title: "Custom Fields",
        description: "Manage custom fields for this company",
        addField: "Add Field",
        editField: "Edit Field",
        addFieldDescription: "Add a new custom field to this company",
        editFieldDescription: "Edit the custom field",
  ...
  companyGroup: {
    ...
    description: "Manage company groups and categories",
    item: "Company Group",
    ...
    manageCompaniesDescription: "Add or remove companies from {{groupName}}",
  },

  // API Keys
  apiKey: {
    title: "API Keys",
    description: "Manage API keys for company authentication",
    item: "API Key",
    items: "API Keys",
    name: "Name",
  ...
  webhook: {
    ...
    companyPlaceholder: "Select company",
    secret: "Secret",
    secretPlaceholder: "Optional secret for signing",
    eventTypesLabel: "Event Types",
    eventTypesPlaceholder: "Select event types",
    status: "Status",
    isActive: "Is Active",
    retryCount: "Retry Count",
    retryCountPlaceholder: "Number of retry attempts",
    timeoutSeconds: "Timeout (seconds)",
    timeoutSecondsPlaceholder: "Request timeout in seconds",
    ...
    deliveries: {
      ...
      description: "View delivery history for {{url}}",
    ...
    eventTypes: {
      ...
      companyResumed: "Company Resumed",
      companyExpired: "Company Expired",
      companyExtended: "Company Extended",
      companyDeleted: "Company Deleted",
      licenseKeyGenerated: "License Key Generated",
  ...
  analytics: {
    ...
    filters: "Filters",
    filtersDescription: "Filter analytics by date range",
    fromDate: "From Date",
    toDate: "To Date",
    apply: "Apply",
    ...
    requestsByDayDescription: "Daily request trends over time",
    requestsByEndpoint: "Requests by Endpoint",
    requestsByEndpointDescription: "Top endpoints by request count",
    requestsByCompany: "Requests by Company",
    requestsByCompanyDescription: "Top companies by request count",
  },
  ...
  report: {
    ...
    generateDescription: "Select a report type and format to generate",
    selectReport: "Select Report",
    selectReportPlaceholder: "Choose a report type",
  ...
  metrics: {
    ...
    description: "View system metrics and performance monitoring",
    ...
    companyStatusDescription: "Distribution of companies by status",
    apiPerformance: "API Performance",
    apiPerformanceDescription: "API request statistics and performance",
  ...
  errorLog: {
    ...
    cleanup: "Cleanup",
    cleanupPrompt: "Enter number of days to keep (older logs will be deleted)",
    levels: {
      debug: "Debug",
      info: "Info",
      warning: "Warning",
  ...
  loginAttempt: {
    ...
    description: "View and track login attempts",
    item: "Login Attempt",
    items: "Login Attempts",
    username: "Username",
    statusLabel: "Status",
  ...
  // Global Search
  search: {
    placeholder: "Search companies, admins, plans...",
    results: "Results",
  ...
  menuItem: {
    ...
    description: "Manage navigation menu items (SuperAdmin only)",
    item: "Menu Item",
    items: "Menu Items",
  ...
  subscriptionPlan: {
    ...
    currency: "Currency",
    currencyPlaceholder: "Enter currency code (e.g., USD)",
  ...
  licensing: {
    ...
    confirmBulkActivate: "Are you sure you want to activate {count} companies?",
    confirmBulkSuspend: "Are you sure you want to suspend {count} companies?",
    confirmBulkResume: "Are you sure you want to resume {count} companies?",
    confirmBulkExtend: "Are you sure you want to extend {count} companies?",
  ...
  dashboard: {
    ...
    apiUsage: {
      ...
      description: "API request statistics for the last 30 days",
      totalRequests: "Total Requests",
      successfulRequests: "Successful",
      failedRequests: "Failed",
      dailyChart: "Daily API Requests",
      requests: "Requests",
      average: "Average",
    ...
    expiryTimeline: {
      ...
      description: "Companies with subscriptions expiring in the next 30 days",
      companies: "companies",
      date: "Date",
      noData: "No companies expiring in the next 30 days",
    },
    recentActivity: {
      title: "Recent Activity",
      description: "Latest system notifications and events",
      viewAll: "View All",
      time: "Time",
      type: "Type",
      message: "Message",
    ...
    metrics: {
      errorRate: "Error Rate",
      errorRateDescription: "Percentage of failed API requests",
      totalRequests: "Total Requests",
      failedRequests: "Failed Requests",
      moduleUsage: "Module Usage",
      moduleUsageDescription: "Active modules and integrations",
  ...
  fileUpload: {
    title: "File Upload",
    description: "Upload files using chunked transfer for large files",
    selectFile: "Select File",
    upload: "Upload",
    uploading: "Uploading...",
    cancel: "Cancel",
    ...
    error: {
      fileTooLarge: "File size exceeds maximum allowed size of {{maxSize}}",
  ...
  fileDownload: {
    title: "File Download",
    description: "Download files using chunked transfer for large files",
    download: "Download",
