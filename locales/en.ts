export const en = {
  ...
  company: {
    ...
    detail: {
      ...
      trial: {
        title: "Trial Period",
        status: "Trial Status",
        description: "Trial period information and management",
        active: "Active Trial",
        endDate: "End Date",
      ...
      subscriptionPlan: {
        ...
        description: "Subscription plan assigned to this company",
        change: "Change Plan",
        changeDescription: "Change the subscription plan for this company",
        selectPlan: "Select Plan",
        noPlan: "No subscription plan assigned",
        assign: "Assign Plan",
      },
      licenseKey: {
        title: "License Key Management",
        description: "Generate and manage license keys for this company",
        generate: "Generate License Key",
        regenerate: "Regenerate License Key",
      },
      analytics: {
        description: "View usage analytics and statistics for this company",
        viewFull: "View Full Analytics",
      },
      history: {
  ...
  featuresPlaceholder: "Enter feature name",
    ...
    detail: {
      ...
      modulesDescription: "Modules in this project",
      addModule: "Add Module",
      addModuleDescription: "Add modules to {{projectName}}",
      addSelected: "Add Selected",
      removeModule: "Remove Module",
      noModules: "No modules in this project",
      noModulesAvailable: "No modules available to add",
      addedAt: "Added At",
    },
    error: {
  ...
  featuresPlaceholder: "Enter feature name",
    ...
    detail: {
      ...
      basicInfo: "Basic Information",
      basicInfoDescription: "Module name, description, and status",
      metadata: "Metadata",
      metadataDescription: "Module creation and update information",
      createdAt: "Created At",
      updatedAt: "Updated At",
      noDescription: "No description",
  ...
  companyGroup: {
    ...
    detail: {
      ...
      description: "View and manage company group details",
      tabs: {
        overview: "Overview",
        companies: "Companies",
        statistics: "Statistics",
      ...
      basicInfo: "Basic Information",
      basicInfoDescription: "Group name, description, and status",
      metadata: "Metadata",
      metadataDescription: "Group creation and update information",
      createdAt: "Created At",
      updatedAt: "Updated At",
      noDescription: "No description",
      companiesDescription: "Companies in this group ({{count}} total)",
      noCompanies: "No companies in this group",
      addCompanies: "Add Companies",
      addCompaniesDescription: "Add companies to {{groupName}}",
      addSelected: "Add Selected",
      ...
      confirmBulkActivateTitle: "Bulk Activate Companies",
      confirmBulkActivateDescription: "Are you sure you want to activate {{count}} companies in this group? You will need to select an expiry date.",
      confirmBulkSuspendTitle: "Bulk Suspend Companies",
      confirmBulkSuspendDescription: "Are you sure you want to suspend {{count}} companies in this group? This action will prevent them from accessing the system.",
      confirmBulkResumeTitle: "Bulk Resume Companies",
      confirmBulkResumeDescription: "Are you sure you want to resume {{count}} companies in this group? This will restore their access to the system.",
      confirmBulkExtendTitle: "Bulk Extend Companies",
      confirmBulkExtendDescription: "Are you sure you want to extend {{count}} companies in this group? You will need to select a new expiry date.",
      statistics: "Statistics",
    ...
    error: {
      title: "Error Loading Company Group",
      loadFailed: "Failed to load company group details",
  ...
  apiKey: {
    ...
    detail: {
      ...
      description: "View and manage API key details",
      tabs: {
        overview: "Overview",
        usage: "Usage",
        settings: "Settings",
      ...
      basicInfo: "Basic Information",
      basicInfoDescription: "API key name, description, and status",
      metadata: "Metadata",
      metadataDescription: "API key creation and usage information",
      createdAt: "Created At",
      updatedAt: "Updated At",
      noDescription: "No description",
    ...
    error: {
      ...
      loadFailed: "Failed to load API key details",
  ...
  webhook: {
    ...
    detail: {
      ...
      description: "View and manage webhook details",
      tabs: {
        overview: "Overview",
      ...
      basicInfo: "Basic Information",
      basicInfoDescription: "Webhook URL, secret, and event types",
      metadata: "Metadata",
      metadataDescription: "Webhook creation and delivery information",
      createdAt: "Created At",
      noSecret: "No secret configured",
  ...
  description: "Manage subscription plans and their hierarchy",
    ...
    detail: {
      ...
      basicInfo: "Basic Information",
      basicInfoDescription: "Plan name, description, and pricing information",
      features: "Features",
      ...
      noCompanies: "No companies using this plan",
      noModulesAvailable: "No modules available to assign",
      addedAt: "Added At",
    },
    error: {
      title: "Error Loading Subscription Plan",
      loadFailed: "Failed to load subscription plan details",
  ...
  settings: {
    ...
    components: {
      ...
      hoverEffect: {
        ...
        elevate: "Lift and shadow",
        scale: "Grow on hover",
        glow: "Glow",
        glowDesc: "Glowing border",
        shimmer: "Shimmer",
        shimmerDesc: "Shimmer animation",
        rotate: "Rotate",
        rotateDesc: "Slight rotation",
        slide: "Slide",
        slideDesc: "Slide movement",
        intensity: {
          none: "No effect",
          small: "Small",
          smallDesc: "Subtle effect",
          medium: "Medium",
          mediumDesc: "Balanced effect",
          strong: "Strong",
          strongDesc: "Bold effect",
        },
      },
    },
    devices: {
  ...
  confirmationDialog: {
    ...
    infoDescription: "Please confirm this action.",
