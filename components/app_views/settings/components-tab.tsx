              ...
              {[
                {
                  ...
                  description: t("settings.components.hoverEffect.none"),
                  icon: Move,
                },
                {
                  value: "elevate",
                  name: t("settings.components.plan.elevate"),
                  description: t("settings.components.hoverEffect.elevate"),
                  icon: MoveUp,
                },
                {
                  value: "scale",
                  name: t("settings.components.plan.scale"),
                  description: t("settings.components.hoverEffect.scale"),
                  icon: ZoomIn,
                },
                {
                  value: "glow",
                  name: t("settings.components.hoverEffect.glow"),
                  description: t("settings.components.hoverEffect.glowDesc"),
                  icon: Sparkles,
                },
                {
                  value: "shimmer",
                  name: t("settings.components.hoverEffect.shimmer"),
                  description: t("settings.components.hoverEffect.shimmerDesc"),
                  icon: Zap,
                },
                {
                  value: "rotate",
                  name: t("settings.components.hoverEffect.rotate"),
                  description: t("settings.components.hoverEffect.rotateDesc"),
                  icon: RotateCw,
                },
                {
                  value: "slide",
                  name: t("settings.components.hoverEffect.slide"),
                  description: t("settings.components.hoverEffect.slideDesc"),
                  icon: Move,
                },
              ].map((effect) => (
                <div
              ...
              {[
                {
                  value: "none",
                  name: t("settings.components.plan.none"),
                  description: t("settings.components.hoverEffect.intensity.none"),
                  intensity: 0,
                },
                {
                  value: "small",
                  name: t("settings.components.hoverEffect.intensity.small"),
                  description: t("settings.components.hoverEffect.intensity.smallDesc"),
                  intensity: 1,
                },
                {
                  value: "medium",
                  name: t("settings.components.hoverEffect.intensity.medium"),
                  description: t("settings.components.hoverEffect.intensity.mediumDesc"),
                  intensity: 2,
                },
                {
                  value: "strong",
                  name: t("settings.components.hoverEffect.intensity.strong"),
                  description: t("settings.components.hoverEffect.intensity.strongDesc"),
                  intensity: 3,
                },
              ].map((intensity) => (
                <div
