 ...
 * Auth Form Card
 * 
 * Provides the animated card styling for authentication forms.
 * Includes:
 * - Animated gradient border
 * - Dynamic glow based on focus state
 * - Corner accents
 * - Backdrop blur and shadow effects
 */
export function AuthFormCard({ children, focusedField }: AuthFormCardProps) {
