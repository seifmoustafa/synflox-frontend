export const en = {
  ...
  dashboard: {
    ...
    subscriptionsDashboard: {
      ...
      subscriptions: "Subscriptions",
      topPlan: "Top Plan",
      topPlanDescription: "Highest revenue generating plan",
    ...
    revenue: {
      ...
      totalRevenue: "Total Revenue",
      totalSubscriptionValue: "Total Subscription Value",
  ...
  company: {
    ...
    phone: "Phone",
    notFound: "Company not found",
    quickActionsDescription: "Perform common operations for this company",
  ...
  plan: {
    ...
    parentPlanHelper: "Inherit projects and modules from a parent plan",
    displayOrder: "Display Order",
    displayOrderHelper: "Order for sorting plans (lower = higher priority)",
    parentPlanName: "Inherits From",
    childPlanCount: "Child Plans",
  ...
  subscription: {
    ...
    noSubscriptionsDescription: "This company doesn't have any subscriptions yet",
    currentPlanDescription: "Current active subscription details",
    activeSubscription: "Active Subscription",
    ...
    currency: "Currency",
    currencyHelper: "Select the payment currency for this subscription",
    selectCurrency: "Select payment currency",
    overridePlanPricing: "Custom Pricing",
    overridePlanPricingHelper: "Enable to set custom currency and amount instead of using plan defaults",
    amount: "Amount",
    amountPlaceholder: "Enter amount",
    amountHelper: "Custom amount for this subscription",
    ...
    startDateHelper: "When the subscription should start (default: today)",
    expiryDate: "Expiry Date",
    daysRemaining: "Days Remaining",
    notes: "Notes",
    notesPlaceholder: "Add any notes about this subscription...",
    notesHelper: "Internal notes for this subscription (max 500 characters)",
    ...
    duplicatePlanNotAllowed: "Company already has an active subscription with this plan",
    expiringWarning: "Subscription Expiring Soon!",
    expiringWarningDesc: "The {plan} subscription will expire in {days} days. Renew now to avoid service interruption.",
    renewNow: "Renew Now",
    timeline: "Subscription Timeline",
    timelineDescription: "Complete history of subscription events",
    viewHistory: "View History",
    exportSuccess: "Subscription history exported successfully",
    exportError: "Failed to export subscription history",
  ...
  companyAdmin: {
    title: "Company Admin",
    description: "Manage client administrator account",
    item: "Company Admin",
    items: "Company Admins",
    company: "Company",
    username: "Username",
    usernamePlaceholder: "Enter username",
    password: "Password",
    ...
    mustChangeOnFirstLogin: "Must change password on first login",
    resetPassword: "Reset Password",
    ...
    // No admin state
    noAdmin: "No Admin Account",
    noAdminDescription: "Create an admin account for {companyName} to manage their licenses and devices.",
    // Dialog titles
    createAdmin: "Create Admin Account",
    createAdminDescription: "Create an admin account for {companyName}",
    editAdmin: "Edit Admin Account",
    editAdminDescription: "Update admin account for {companyName}",
    deleteAdmin: "Delete Admin Account",
    deleteAdminConfirmation: "Are you sure you want to delete the admin account for {adminName}? This action cannot be undone.",
    resetPasswordDescription: "Set a new password for {adminName}",
    sessionHistoryDescription: "View session history for {adminName}",
    permissions: {
      title: "Permissions",
      manageDevices: "Manage Devices",
      viewSubscriptions: "View Subscriptions",
      approveReplacements: "Approve Replacements",
      generateLicenses: "Generate Licenses",
      viewReports: "View Reports",
      modifySessionSettings: "Modify Session Settings",
    },
    status: {
      active: "Active",
      inactive: "Inactive",
